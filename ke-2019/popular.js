...
$.getJSON("https://popping-inferno-4625.firebaseio.com/users-ke-2019.json")
    .then(function (users) {
        $.getJSON("https://popping-inferno-4625.firebaseio.com/teams-ke-2019.json", function (teams) {
            var teams_counter = {};
            var users_count = 0;
