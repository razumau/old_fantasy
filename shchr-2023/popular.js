...
$.getJSON("https://popping-inferno-4625.firebaseio.com/users-shchr-2023.json")
    .then(function (users) {
        $.getJSON("https://popping-inferno-4625.firebaseio.com/teams-shchr-2023.json", function (teams) {
            var teams_counter = {};
            var users_count = 0;
