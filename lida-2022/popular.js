...
$.getJSON("https://popping-inferno-4625.firebaseio.com/users-lida-2022.json")
    .then(function (users) {
        $.getJSON("https://popping-inferno-4625.firebaseio.com/teams-lida-2022.json", function (teams) {
            var teams_counter = {};
            var users_count = 0;
