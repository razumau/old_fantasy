...
$.getJSON("https://popping-inferno-4625.firebaseio.com/users-shchrb-2018.json")
    .then(function (users) {
        $.getJSON("https://popping-inferno-4625.firebaseio.com/teams-shchrb-2018.json", function (teams) {
            var teams_counter = {};
            var users_count = 0;
