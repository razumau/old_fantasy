		...
		if (this.state.user.teams) {
			...
			return (React.createElement("div", { className: "userBox" },
				...
				React.createElement("div", {id:"selectionsLinkTeams"},
					React.createElement("a", {href:"https://fantasy.razumau.net/shchrb-2018/selections", id: "selectionsLink"}, "Кого выбрали другие?"))
				)
			);
		} else {
			return (React.createElement("div", { className: "userBox" },
				...
				React.createElement("p", null, "Изменения можно делать до 10:00 14 апреля."),
				React.createElement("div", {id:"selectionsLinkRules"}, 
					React.createElement("a", {href:"https://fantasy.razumau.net/shchrb-2018/results", id: "selectionsLink"}, "Кого выбрали другие?"))
				)
...
function authCallback(authData) {
	if (authData) {
		hideLoginButtons();
		userRef = rootRef.child("users-shchrb-2018").child(authData.uid);
...
function showTable() {
	$table.bootstrapTable({
		method: 'get',
		url: 'https://popping-inferno-4625.firebaseio.com/teams-shchrb-2018.json',
		cache: false,
		clickToSelect: true,
		columns: [{
			field: 'state',
