...
$.getJSON("https://popping-inferno-4625.firebaseio.com/users-vf-2020.json")
    .then(function (users) {
        $.getJSON("https://popping-inferno-4625.firebaseio.com/teams-vf-2020.json", function (teams) {
            var teams_counter = {};
            var users_count = 0;
