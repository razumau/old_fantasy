...
$.getJSON("https://popping-inferno-4625.firebaseio.com/users-schrb-2018.json")
    .then(function (users) {
        $.getJSON("https://popping-inferno-4625.firebaseio.com/teams-schrb-2018.json", function (teams) {
            var teams_counter = {};
            var users_count = 0;
