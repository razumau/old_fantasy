    ...
    render: function () {
        ...
        if (this.state.user.teams) {
            ...
            return (React.createElement("div", {className: "userBox"},
                    ...
                    React.createElement("div", {id: "selectionsLinkTeams"},
                        React.createElement("a", {
                            href: "https://fantasy.razumau.net/cap-2023/results",
                            id: "selectionsLink"
                        }, "Кого выбрали другие?"))
                )
            );
            ...
            return (React.createElement("div", {className: "userBox"},
                    ...
                    React.createElement("p", null, "Изменения можно делать до 12:00 25 марта."),
...
function showTable() {
    $table.bootstrapTable({
        method: 'get',
        url: 'https://popping-inferno-4625.firebaseio.com/teams-cap-2023.json',
        cache: false,
        clickToSelect: true,
        columns: [{
            field: 'state',
