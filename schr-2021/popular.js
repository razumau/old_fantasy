...
$.getJSON("https://popping-inferno-4625.firebaseio.com/users-schr-2021.json")
    .then(function (users) {
        $.getJSON("https://popping-inferno-4625.firebaseio.com/teams-schr-2021.json", function (teams) {
            var teams_counter = {};
            var users_count = 0;
