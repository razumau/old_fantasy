...
$.getJSON("https://popping-inferno-4625.firebaseio.com/users-si-2024.json")
    .then(function (users) {
        $.getJSON("https://popping-inferno-4625.firebaseio.com/teams-si-2024.json", function (teams) {
            var teams_counter = {};
            var users_count = 0;
    ...
    render: function () {
        ...
        return (
            React.createElement("div", {className: "resultsList"},
                React.createElement('h3', null, 'Популярные игроки'),
                React.createElement('p', null, 'Процент участников, взявших игрока в\u00A0свою сборную (в\u00A0скобках — цена игрока).'),
