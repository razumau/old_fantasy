    ...
    render: function () {
        ...
        if (this.state.user.teams) {
            ...
            return (React.createElement("div", {className: "userBox"},
                    ...
                    React.createElement("div", {id: "selectionsLinkTeams"},
                        React.createElement("a", {
                            href: "https://fantasy.razumau.net/schrb-2019/results",
                            id: "selectionsLink"
                        }, "Кого выбрали другие?"))
                )
            );
            ...
            return (React.createElement("div", {className: "userBox"},
                    ...
                    React.createElement("p", null, "Изменения можно делать до 9:00 5 мая."),
                    React.createElement("p", {id: "ratingLink"},
                        React.createElement("a", {
                            href: "https://rating.chgk.info/tournament/5155",
                            id: "ratingLink",
                            target: "_blank"
...
function showTable() {
    $table.bootstrapTable({
        method: 'get',
        url: 'https://popping-inferno-4625.firebaseio.com/teams-schrb-2019.json',
        cache: false,
        clickToSelect: true,
        columns: [{
            field: 'state',
